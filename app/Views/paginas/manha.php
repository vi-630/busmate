...
<section class="app-layout">
  ...
  <head>
  <link rel="stylesheet" href="<?= URL ?>/public/css/manha.css">
</head>
...
<main class="manha-content">
  ...
  <figure class="bus-hero">
    <img src="<?=URL?>/public/img/onibus-escolar.png" alt="Ônibus - Linha da manhã" class="bus-photo">
  </figure>
  ...
  <section class="info-card">
    ...
    <div class="horarios-ponto">
      ...
      <ul>
        <li><strong>Saída do ponto:</strong> 06:00 AM</li>
        <li><strong>Chegada Destino:</strong> 07:00</li>
        <li><strong>Saída do Destino:</strong> 12:20</li>
      </ul>
    </div>
  </section>
</main>
